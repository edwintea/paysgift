package com.gateway.paysgift.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.gateway.paysgift.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.gateway.paysgift.security.DomainUserDetailsService", "createSpringSecurityUser");
