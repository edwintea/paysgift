package com.paysgift.orderservice.security.jwt;

import static com.paysgift.orderservice.security.SecurityUtils.AUTHORITIES_KEY;
import static com.paysgift.orderservice.security.SecurityUtils.JWT_ALGORITHM;
