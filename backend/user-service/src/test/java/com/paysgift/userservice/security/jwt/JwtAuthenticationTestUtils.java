package com.paysgift.userservice.security.jwt;

import static com.paysgift.userservice.security.SecurityUtils.AUTHORITIES_KEY;
import static com.paysgift.userservice.security.SecurityUtils.JWT_ALGORITHM;
